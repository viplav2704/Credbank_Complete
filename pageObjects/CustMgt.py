...
class CustMgt_Class:
    ...
    Verify_Success_Createuser_Xpath = (By.XPATH,"//div[@class='success-message']")
    ...
    def Validate_Search(self):
        try:
            print("Searching Customer >>",self.driver.find_element(*CustMgt_Class.Verify_ErrorMsg_Xpath).text)
            return "fail"
    ...
    def Validate_CreateCust(self):
        try:
            self.driver.find_element(*CustMgt_Class.Verify_Success_Createuser_Xpath)
            return "pass"
